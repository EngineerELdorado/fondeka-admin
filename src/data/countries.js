...
// Helper to render emoji flags from ISO2 codes (e.g., "CD" -> "🇨🇩")
...
const COUNTRIES = [
  ...
  { cca2: 'AX', name: 'Åland Islands', callingCode: '358' },
  ...
  { cca2: 'CW', name: 'Curaçao', callingCode: '599' },
  ...
  { cca2: 'TR', name: 'Türkiye', callingCode: '90' },
