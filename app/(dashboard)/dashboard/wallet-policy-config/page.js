  ...
  const save = async () => {
    ...
    try {
      const nextConfig = {
        ...
        sendAirtimeMinimumUsd: sendAirtimeMinimumRaw === '' ? null : sendAirtimeMinimumParsed.toFixed(2),
        paypalMinimumPayoutUsd: paypalMinimumPayoutRaw === '' ? null : paypalMinimumPayoutParsed.toFixed(2),
        payoutKycThresholdUsd: payoutKycThresholdRaw === '' ? null : payoutKycThresholdParsed.toFixed(2),
