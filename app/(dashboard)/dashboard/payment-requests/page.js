...
const sections = [
  ...
  { href: '/dashboard/payment-requests/wallet-settlement-policy', title: 'Wallet Settlement Currency', blurb: 'Choose whether wallet-funded payment requests settle in request or payer currency.' }
];
