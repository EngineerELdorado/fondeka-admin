...
const enhancedKycVerifications = {
  ...
  createForAccount: (accountId, payload, files = {}) => {
    ...
    if (presentFiles.length > 0) {
      ...
      return request(`/enhanced-kyc-verifications/accounts/${accountId}`, { method: 'POST', body: formData });
    }
    return request(`/enhanced-kyc-verifications/accounts/${accountId}`, { method: 'POST', body: toBody(payload) });
  },
