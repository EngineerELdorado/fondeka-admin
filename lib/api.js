...
const transactions = {
  ...
  refundLookupByInternalReference: (internalReference) =>
    request(withQuery('/admin/transactions/refunds/by-internal-reference', { internalReference })),
  refundLookupByTransactionId: (transactionId) => request(`/admin/transactions/${transactionId}/refunds/lookup`),
